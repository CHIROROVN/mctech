...
@section('content')
    ...
    <section id="page">
        ...
        <div class="col-md-12 text-center">
            <br>
            <input value="一覧へ戻る" onclick="location.href='{{ route('backend.users.index') }}'" type="button" class="btn btn-sm btn-page">　
            <input value="変更する" onclick="location.href='{{ route('backend.users.edit', $user->u_id) }}'" type="button" class="btn btn-sm btn-page">
            　<input value="削除する" onclick="location.href='{{ route('backend.users.delete.cnf', $user->u_id) }}'" type="button" class="btn btn-sm btn-page">
        </div>
    </section>
    <!--END PAGE CONTENT -->
@endsection  