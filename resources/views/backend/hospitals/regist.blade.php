...
@section('content')
    <!--PAGE CONTENT -->
    {!! Form::open( ['method' => 'post', 'route' => 'backend.hospitals.regist', 'enctype'=>'multipart/form-data']) !!}
    <section id="page">
        <div class="container">
            <div class="row content-page">
                ...
                <table class="table table-bordered treatment2-list">
                    <tbody><tr>
                        <td width="17%" class="col-title"><font color="red">※</font>表示名</td>
                        <td>
                    ...
                    <tr>
                        <td class="col-title"><font color="red">※</font>正式名称</td>
                        <td>
                    ...
                    <tr>
                        <td class="col-title"><font color="red">※</font>院長名</td>
                        <td>
                    ...
                    <tr>
                        <td class="col-title"><font color="red">※</font>郵便番号</td>
                        <td>
                    ...
                    <tr>
                        <td class="col-title"><font color="red">※</font>住所</td>
                        <td>
                    ...
                    <tr>
                        <td class="col-title"><font color="red">※</font>電話番号</td>
                        <td>
