    ...
    <div class="row content-page">
      ...
      <div class="row margin-bottom">
          <div class="col-md-12 text-center">
            <p>&nbsp;            </p>
            <p>
              <input value="戻る" onclick="location.href='manage_shift_in_sent.html'" type="button" class="btn btn-sm btn-page">
            　　
            <input value="登録する" onclick="location.href='manage_shift_holiday_in_sent.html'" type="button" class="btn btn-sm btn-page">
            </p>
          </div>
        </div>
    </div>
