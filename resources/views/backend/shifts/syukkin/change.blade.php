      ...
      <div class="container">
        ...
        <div class="row margin-bottom">
          <div class="col-md-12 text-center">
            <input value="戻る" onclick="location.href='shift_syukkin.html'" type="button" class="btn btn-sm btn-page">　　　<input value="確認" onclick="location.href='shift_syukkin_change_cnf.html'" type="button" class="btn btn-sm btn-page">
          </div>
        </div>
      </div>
    </section>
