      ...
      <di	v class="container">
        <div class="row content-page">
          ...
          <table class="table table-bordered treatment2-list" style="width:30%;margin:0 auto;float:none;margin-bottom:20px;">
            ...
            <tr>
              <td width="50%" align="center"><input type="input" class="form-control form-control--default"></td>
            </tr>
            <tr>
              <td align="center" ><select style="width:10%;">
        ...
        <div class="row margin-bottom">
          <div class="col-md-12 text-center">
            <input value="戻る" onclick="location.href='shift_shubetsu.html'" type="button" class="btn btn-sm btn-page">　　　<input value="確認" onclick="location.href='shift_shubetsu_regist_cnf.html'" type="button" class="btn btn-sm btn-page">
          </div>
        </div>
      </div>
    </section>
