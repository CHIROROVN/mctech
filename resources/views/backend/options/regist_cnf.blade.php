        ...
        <div class="container">
            ...
            <div class="row margin-bottom">
                <div class="col-md-12 text-center">
                    <input value="戻る" onclick="location.href='{{ route('backend.options.regist', ['back' => 'back']) }}'" type="button" class="btn btn-sm btn-page">
                    <input value="登録" onclick="location.href='{{ route('backend.options.regist.end') }}'" type="button" class="btn btn-sm btn-page mar-left5">
                </div>
            </div>
        </div>
    </section>
