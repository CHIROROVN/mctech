        ...
        <div class="container">
            ...
            <div class="row margin-bottom">
                <div class="col-md-12 text-center">
                    <input value="戻る" onclick="location.href='{{ route('backend.materials.detail', $material->material_id) }}'" type="button" class="btn btn-sm btn-page">
                    <input value="削除する" onclick="location.href='{{ route('backend.materials.delete.end', $material->material_id) }}'" type="button" class="btn btn-sm btn-page mar-left5">
                </div>
            </div>
        </div>
    </section>
